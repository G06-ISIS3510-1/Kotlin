...
interface RideRepository {
    ...
    fun observeCreateRideDrafts(driverId: String): Flow<List<CreateRideDraftSummary>>
    fun observeCreateRideDraftSummary(driverId: String): Flow<CreateRideDraftSummary?>
    ...
    suspend fun getCreateRideDraft(draftId: String): CreateRideDraft?
    ...
    suspend fun retryPendingRidePublish(id: String): Boolean
